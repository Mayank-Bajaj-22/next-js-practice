    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black text-white px-4">
            <div className="w-full max-w-md border-2 border-white rounded-2xl p-8 shadow-lg bg-gray-900">
                ...
                <button className="w-full flex items-center justify-center gap-2 py-2 px-4 border border-gray-400 rounded-lg bg-white text-black hover:bg-gray-100 transition-colors" onClick={() => signIn("google")}>
                ...
                <p className='text-sm text-center mt-3 cursor-pointer' onClick={() => router.push("/login")}>Already have an account ? <span className='text-blue-400 hover:underline'>login</span></p>
            </div>
        </div>
    )
}
